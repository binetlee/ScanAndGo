...
const createCreds = async function() {
  ...
  const publicKey = {
    ...
    // relying party
    rp: {
      name: 'Sample Relying Party' // sample relying party
    },
    user: {
...
const validateCreds = async function(){
  ...
  const AUTH_CHALLENGE = 'someRandomStringThatSHouldBeReLLYLoooong&Random';
  const publicKey = {
    // your domain
    rpId: "localhost",
...
export function Security() {
  ...
  createCreds().then(() => validateCreds());
  ...
  // }).then((res) => {
  //   console.log(res);
  //   console.log(binToStr(res.rawId));
  //   console.log(binToStr(res.id));
  // })
...
//   });
  ...
  return (
    <>
      ...
      <div>
        For your security, please verify your identify using your mobile device.
      </div>
    </>
  )
}
